...
class SuckerThread2(QThread):
    ...
    def __init__(self, params: dict, HM: Hardware_Manager, MM: ModBus_Manager, ui: 'MainWindow'):
        ...
        self.cam_alias = "sucker2_cam"
        self.modbus_alias = "sucker2_modbus"
        ...
        while True:
            ...
            if trigger == 1 and trigger_last == 0:
                ...
                try:
                    ...
                    print(f"SuckerThread2 Modbus write error: {e}")
            ...
            # 实时显示（带辅助线）
            if image is not None and hasattr(self.ui, "radioButton_live_sucker2") and self.ui.radioButton_live_sucker2.isChecked():
                h, w = image.shape[:2]
                img_live = image.copy()
